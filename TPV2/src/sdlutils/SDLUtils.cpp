...
SDLUtils::SDLUtils(std::string windowTitle, int width, int height) :
	...
	width_(width), //
	height_(height), //
	fontsAccessWrapper_(fonts_, "Font"), //
	imagesAccessWrapper_(images_, "Images"), //
	msgsAccessWrapper_(msgs_, "Msgs"), //
	soundsAccessWrapper_(sounds_, "Sounds"), //
	musicsAccessWrapper_(musics_, "Musics")
{
